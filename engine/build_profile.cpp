...
static const PinSig kSteamPins[] = {
    ...
    // --- engine calls made by engine/console.cpp to print a console line ---
    { 0x00553210, { 0x6A,0xFF,0x68,0x00,0x77,0x86,0x00 },      7, false, "cEventUI2 ctor" },
    { 0x004B2410, { 0x6A,0xFF,0x68,0x73,0x28,0x86,0x00 },      7, false, "cEventUI2 dtor" },
    { 0x00808E50, { 0x6A,0xFF,0x68,0x9F,0x9E,0x88,0x00 },      7, false, "cKernel singleton" },
    { 0x008092F0, { 0x64,0xA1,0x00,0x00,0x00,0x00,0x6A,0xFF }, 8, false, "cKernel::receive_event" },
    { 0x008911D8, { 0x50,0x36,0x55,0x00 },                     4, false, "cEventUI_string vftable" },
};
