# Open item #4: FUN_0048f9e0 = the Dialog (tag 0x1f) handler. How does it turn
# the dialog NPC name + text resource into the +0x4c content handle? That is
# the resolution our say() shim is getting wrong (random text).
...
o = va2off(0x48f9e0)
for ins in md.disasm(d[o:o + 0x280], 0x48f9e0):
    note = ''
